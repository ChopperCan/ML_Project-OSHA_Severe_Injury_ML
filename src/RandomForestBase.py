...
VAL_PRED_CSV  = "data/RandomForest_Validation_Predictions.csv"
TEST_PRED_CSV = "data/RandomForest_Test_Predictions.csv"
...
def main():
    ...
    print("\nRandom Forest model and outputs saved successfully.")
